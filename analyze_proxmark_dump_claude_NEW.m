...
manufacturers = containers.Map('KeyType', 'uint8', 'ValueType', 'char');
manufacturers(hex2dec('04')) = 'NXP Semiconductors';
manufacturers(hex2dec('02')) = 'ST Microelectronics';
manufacturers(hex2dec('05')) = 'Infineon Technologies';
manufacturers(hex2dec('08')) = 'Various/Magic Card';
manufacturers(hex2dec('09')) = 'Fudan Microelectronics';
manufacturers(hex2dec('0A')) = 'NXP/Shanghai Fudan';
manufacturers(hex2dec('88')) = 'Cascade (multi-byte UID)';

if isKey(manufacturers, uid_bytes(1))
    manufacturer = manufacturers(uid_bytes(1));
else
